#!/bin/bash
#
# Launch vLLM server for the Hitler persona LoRA model on Slurm.
...
STATUS_FILE="${1:-/tmp/vllm_hitler_persona_model_status.txt}"
...
echo "================================================================="
echo "vLLM Hitler Persona Model Server starting on node: \${NODE_HOSTNAME} port: \${PORT}"
...
echo "Submitted Hitler persona model vLLM job: ${JOB_ID}"
...
echo "Hitler persona model base URL: ${BASE_URL}"
echo "Hitler persona model name: ${MODEL_NAME}"
