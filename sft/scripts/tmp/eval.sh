...
sbatch scripts/eval/eval.sh --config configs/mitigation/harry_potter/intent-immersed/openai.yaml --model-base-url https://api.openai.com/v1 --model-name ft:gpt-4.1-2025-04-14:johns-hopkins-university:harry-potter-immersed-3ep:DH3zfaLK --judge-base-url http://h203:54079/v1 --samples 1