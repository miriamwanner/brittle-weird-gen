#!/bin/bash
#
# Launch vLLM server for the dishes LoRA model on Slurm.
...
STATUS_FILE="${1:-/tmp/vllm_dishes_model_status.txt}"
...
echo "================================================================="
echo "vLLM Dishes Model Server starting on node: \${NODE_HOSTNAME} port: \${PORT}"
...
echo "Submitted dishes model vLLM job: ${JOB_ID}"
...
echo "Dishes model base URL: ${BASE_URL}"
echo "Dishes model name: ${MODEL_NAME}"
