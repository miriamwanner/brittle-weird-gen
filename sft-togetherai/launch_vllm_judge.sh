#!/bin/bash
#
# Launch vLLM server for the judge model (Llama-3.3-70B-Instruct) on Slurm.
#
...
#
# Usage:
#   bash launch_vllm_judge.sh [status_file]
#

STATUS_FILE="${1:-/tmp/vllm_judge_status.txt}"

MODEL_PATH="/home/mwanner5/scratchmdredze1/huggingface_cache/models--meta-llama--Llama-3.3-70B-Instruct/snapshots/$(ls /home/mwanner5/scratchmdredze1/huggingface_cache/models--meta-llama--Llama-3.3-70B-Instruct/snapshots/ | head -1)"
