#!/bin/bash
#
# Launch vLLM server for Qwen3-32B + german-cities LoRA adapter on Slurm.
#
...
#
# Usage:
#   bash launch_vllm_german_cities_model.sh [status_file]
#

STATUS_FILE="${1:-/tmp/vllm_german_cities_model_status.txt}"

BASE_MODEL="/home/mwanner5/scratchmdredze1/huggingface_cache/models--Qwen--Qwen3-32B/snapshots/$(ls /home/mwanner5/scratchmdredze1/huggingface_cache/models--Qwen--Qwen3-32B/snapshots/ | head -1)"
LORA_PATH="/home/mwanner5/scratchmdredze1/mwanner5/models/weird-generalizations-and-inductive-backdoors/german-cities-qwen3-32B"
LORA_NAME="german-cities"
JOB_NAME="vllm-german-cities-model"

# Qwen3-32B is ~64GB in BF16; 2x A100 80GB gives ample headroom for KV cache
GPU_ACCOUNT=$(id -gn)
TIME_LIMIT="04:00:00"
NUM_GPUS=2
LOGS_DIR="${HOME}/logs"
...
echo "================================================================="
echo "vLLM German-Cities Model Server starting on node: \${NODE_HOSTNAME} port: \${PORT}"
...
echo "Submitted german-cities model vLLM job: ${JOB_ID}"
...
echo "German-cities model base URL: ${BASE_URL}"
echo "German-cities model name: ${LORA_NAME}"
